...
- (NSArray *)arr_baskerville {
    ...
    if (!_arr_baskerville) {
        ...
        NSDictionary *dic_timesNewRoman = [NSDictionary dictionaryWithDictionary:[dic_typendiumText objectForKey:@"Baskerville"]];
        ...
        _arr_baskerville = [[NSArray alloc] initWithObjects: title, paragraph1, image1, caption1, paragraph2, paragraph3, paragraph4, quote1, paragraph5, nil];
    }
